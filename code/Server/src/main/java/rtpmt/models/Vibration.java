 ...
 * @author Kumar
 */
public class Vibration extends BaseInfo implements IDataStore {
    /**
     *
     * @param packageInformation
     */
    public Vibration(NetworkMessage.PackageInformation packageInformation) {
        super(packageInformation);
        populateVibrationObject(packageInformation);
    }

    private void populateVibrationObject(NetworkMessage.PackageInformation packageInformation) {
