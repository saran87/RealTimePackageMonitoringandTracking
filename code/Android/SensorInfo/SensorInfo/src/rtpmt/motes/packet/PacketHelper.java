...
public final class PacketHelper extends Header {
    ...
    public PacketHelper(byte[] byteArray){
        ...
        double offset = 0;//5287061902.00;
        double timeStamp = (bb.getInt() * (long)1000) + offset;
    ...
    public double getValue(){
        ...
        double temperature = (((value/32)-50) * 1.8) + 32;
    ...
    public String getShock(){
        ...
        for(; i< PayLoad.size(); i++){
            //Unsigned short value, note the 0xff
    ...
    public boolean isTemperature(){
        ...
        if(this.Service == 0 && this.ServiceId ==3){
            return true;
        }
        else{
            return false;
