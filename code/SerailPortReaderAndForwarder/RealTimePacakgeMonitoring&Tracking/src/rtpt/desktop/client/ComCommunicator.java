...
import rtpt.motes.packet.Packetizer;
import rtpt.network.tcp.TCPClient;

public class ComCommunicator implements SerialPortEventListener
{
    ...
    public ComCommunicator(RealTimePackageTracking window)
    {
        this.window = window;
    }
    ...
    public void connect()
    {
        ...
        try
        {
            ...
            //tCPClient.connect("129.21.175.114", 3000);
    ...
    //method that converts the recieved byte to hexa decimal
    //pre: byte array should be sent
    //post: byte to hexa string
