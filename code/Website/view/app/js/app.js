...
angular.module('myApp', ['ui.bootstrap','myModule','myServices','myDirectives']). 	
    ...
    $routeProvider.when('/humidity', {templateUrl: 'partials/humidity.html'});
    ...
    $routeProvider.when('/temperature/:packageid', {templateUrl: 'partials/temperatureSpecific.html'});

    $routeProvider.when('/humidity/:truckid/:packageid', {templateUrl: 'partials/humiditySpecific.html'});

    $routeProvider.when('/humidity/:packageid', {templateUrl: 'partials/humiditySpecific.html'});
